...
import '../home_screen_related/book_appointment_related/offline_date_selector/offline_booking_date_selector.dart';

class OfflineTimeChangerWidget extends HookConsumerWidget {
  const OfflineTimeChangerWidget({
    Key? key,
              ...
              return ElevatedButton(
                onPressed: () async {
                  ...
                  final result = await ref
                      ...
                      .changeAlreadyBookedOfflineTime(
                        context,
                        errorState,
                        appointmentId,
                      );
